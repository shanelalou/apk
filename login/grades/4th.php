	...
	<script>
		$(function(){
			...
			$('#grid').flexigrid({
				...
				colModel : [
			{display: 'SUBJECT CODE', name : 'SubjectCode', width : 150, align: 'center'},
					{display: 'SUBJECT TITLE', name : 'SubjectTitle', width : 400, align: 'center'},
					...
					{display: 'TIME', name : 'Time', width : 140, align: 'left' },
					{display: 'RM', name : 'Room', width : 70, align: 'left' },
...
<body>
	<div >
		<div >
			<div  style="font-size:35px"><?php header('Access-Control-Allow-Origin: http://gordoncollegeccs.edu.ph/'); echo $_SESSION['student'].' - '.student($_SESSION['student'],"lastname").", ".student($_SESSION['student'],"firstname").", ".student($_SESSION['student'],"middlename")." - ".student($_SESSION['student'],"course")." ".student($_SESSION['student'],"year"); ?></div>
		</div>
	</div>
