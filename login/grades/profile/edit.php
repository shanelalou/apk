...
echo "<table>";
		...
		echo "<tr/>";
		echo "<tr>";
		echo "<td>Address:</td>"."<td>"."<input type=text name=lugar value='".student($_SESSION['student'],'address')."'";
		echo "</tr>";
		echo "<tr>";
		echo "<td>Contact Number:</td>"."<td>"."<input type=number maxlength=11 name=contactnum value='".student($_SESSION['student'],'contact')."'"."</td>";
		echo "</tr>";
		echo "<tr>";
		echo "<td>Birthday:</td>"."<td>"."<input type=text name=bday value='".student($_SESSION['student'],'birthday')."'"."</td>";
		echo "</tr>";
			echo "<tr>";
		echo "<td><button><a href=prof.php >BACK</a></button></td>"."<td>"."<input type=submit value='UPDATE'>"."</td>";
		echo "</tr>";
	echo "</form>";
	echo "</table>";
	echo "</div>";
