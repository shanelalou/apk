		...
		$(function(){
			...
			$('#grid').flexigrid({
				...
				dataType: 'json',
					...
					{name: '<a style=" text-decoration: none;" href="index.php">VIEW GRADES</a>'} ,
					{separator:true},{separator:true},
				...
				colModel : [
					...
					{display: 'INSTRUCTOR', name : 'Instructor', width : 220, align: 'left'},
					{display: 'CLASS CODE', name : 'ClassCode', width : 60, align: 'left', hide:true },
					{display: 'DAY', name : 'Time', width : 50, align: 'left' },
					{display: 'TIME', name : 'Time', width : 190, align: 'left' },
					{display: 'RM', name : 'Room', width : 40, align: 'left' },
...
<body>
	<div >
		<div >
			<div  style="font-size:35px"><?php echo $_SESSION['student'].' - '.student($_SESSION['student'],"lastname").", ".student($_SESSION['student'],"firstname").", ".student($_SESSION['student'],"middlename")." - ".student($_SESSION['student'],"course")." ".student($_SESSION['student'],"year"); ?></div>
		</div>
	</div>
